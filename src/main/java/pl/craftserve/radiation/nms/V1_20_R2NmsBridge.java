...
public class V1_20_R2NmsBridge implements RadiationNmsBridge {
    static final Logger logger = Logger.getLogger(V1_20_R2NmsBridge.class.getName());
    ...
    public V1_20_R2NmsBridge(String version) {
        ...
        try {
            ...
            this.registryMaterialsUnregisteredIntrusiveHolders = registryMaterialsClass.getDeclaredField("m"); // m -> unregisteredIntrusiveHolders
            ...
            throw new RuntimeException("Failed to initialize 1.20.2 bridge", e);
        }
    }
